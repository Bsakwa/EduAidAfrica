...
const Contacts = () => {
  ...
  return (
    <div className=' main_contacts w-full h-full'>
      <div className="roll h-full w-full bg-[#000000b5]  p-8">
           <h1 className='flex justify-center items-center text-4xl   font-roboto text-blue-100  font-semibold capitalize'>contact us </h1>
            <div className="container flex justify-between items-center gap-8 p-8 mx-auto  ">
              ...
              <div className='flex gap-4 items-center'>
                ...
                <div className='flex flex-col gap-2'>
                  <h1 className='text-blue-100'>PHONE:</h1>
              ...
              <div className='flex gap-4 items-center'>
                ...
                <div className='flex flex-col gap-2'>
                  <h1 className='text-blue-100'>EMAIL:</h1>
              ...
              <div className='flex gap-4 items-center'>
                ...
                <div className='flex flex-col gap-2'>
                    <h1 className='text-blue-100'>WEBSITE:</h1>
