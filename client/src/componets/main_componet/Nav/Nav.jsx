  ...
  return (
    <header className="flex flex-row z-2 absolute w-full justify-between items-center px-8 py-4 bg-gradient border-none">
      ...
      <nav className="w-full h-full flex text-white  flex-row justify-between items-center text-body font-semibold">
        <NavLink className="nav_list mr-4" to="/">
          Home
        </NavLink>
        <NavLink className="nav_list mr-4" to="/learners">
          {" "}
          Scholarship Type
        </NavLink>
        <NavLink className="nav_list mr-4" to="/educators">
          About Us
        </NavLink>
        <NavLink className="nav_list mr-4" to="/partners">
          contact us
        </NavLink>
      </nav>
